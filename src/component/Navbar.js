          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-a active">
                <Link className="nav-a active mx-2" style={{textDecoration:'none',color:props.mode==='light'?'black':'white'}} aria-current="page" to="/">Home</Link>
              </li>
              <li className="nav-a active">
                <Link className="nav-a active mx-2" style={{textDecoration:'none',color:props.mode==='light'?'black':'white'}} aria-current="page" to="/about">About</Link>
              </li>
